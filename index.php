        ...
        <div class="full-bg-img">
            <div class="mask rgba-purple-light flex-center">
                <div class="container text-center  wow fadeInUp">
                    ...
                    <br>
                    <h5>En esta web podrás informarte de las fechas de lanzamiento de tus juegos favoritos</h5>
...
<body>
    ...
    <div class="card-deck">
    <div class="card">
        <img src="img/cyberpunk.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h5 class="card-title">Se retrasa el lanzamiento</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
            <p class="card-text"><small class="text-muted">10/10/2020</small></p>
            <button type="button" class="btn btn-outline-danger btn-lg waves-effect">Leer más</button>
        </div>
    </div>
    <div class="card">
        <img src="img/coldwar.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h5 class="card-title">Beta abierta del nuevo COD</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title">Valorant Acto 3</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
            <button type="button" class="btn btn-outline-danger btn-lg waves-effect">Leer más</button>
        </div>
        ...
        <footer>
            ...
            <div class="container-fluid bg-copyright">
                <div class="container text-center">
                    <p class="copyright">
                        &copy; 2020 VideoJuegos. Todos los derechos reservados
                    </p>
                </div>
            </div>
            <!-- end sub footer -->
